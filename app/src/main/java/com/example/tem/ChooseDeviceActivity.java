...
public class ChooseDeviceActivity extends AppCompatActivity {
    ...
    private String ssid = "neo-analog";
    private String password = "csu85321";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pairedListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                //ssid=deviceInfo.split("\n")[0];
                //password="1234567890";
                Log.e(TAG, "onItemClick:deviceInfo:"+deviceInfo);
                Log.e(TAG, "onItemClick:ssid:"+ssid);
                //连接蓝牙，同时提交WiFi连接申请
                try {
                    startWifi();
    ...
    public void startWifi() throws InterruptedException{
        WifiUtil wifiUtil=new WifiUtil(ChooseDeviceActivity.this);
        boolean openWifi = wifiUtil.OpenWifi();
        Log.e("111111111111","openWifi："+openWifi);
        if(openWifi){
            boolean connectNet = wifiUtil.addNetWork(ssid,password,3);
            Log.e("111111111111","wifi连接成功");
        }else{
            Log.e("111111111111","wifi连接失败");
        }
    }
